...
public class EntryController {
    ...
    @Operation(summary = "Get a list of AI Questions for an entry", description = "Returns a list of questiosn generated by GPT3.5")
    @GetMapping("/{entryId}/aiquestions")
    @ResponseStatus(HttpStatus.OK)
    public List<Questions> getAIQuestionsForEntry(@PathVariable Long entryId) {
        return entryService.getAIQuestionsForAnEntry(entryId);
    }
